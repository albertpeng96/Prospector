...
public class FloatingScore : MonoBehaviour
{
    ...
    // Note the use of parameter for eTimeS & eTimeD
    ...
    void Update()
    {
        ...
        if (u < 0)
        { // If u<0, then we should not move yet.
            state = FSState.pre;
        ...
        else
        {
            ...
            { // If u>= 1, we are done moving
                ...
                { // If there is a callback GameObject
            ...
            {
                // If fontSizes has values in it, then adjust the font size of this GUI text
